...
export const COMMANDS = Object.freeze(['init','doctor','bind','inspect','targets','components','stacks','controls','skills','languages','providers','rules','schedule','plan','audit','verify','explain','report','fix','hooks','mcp','run','contract','state'].map((name) => Object.freeze({ name })));
