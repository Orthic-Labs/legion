...
```powershell
py -3.11 D:/workspace/tools/lib/goalroute/scripts/validate-route.py <route.json> --write-receipt <route.receipt.json>
```

macOS:

```bash
python3 /workspace/tools/lib/goalroute/scripts/validate-route.py <route.json> --write-receipt <route.receipt.json>
```

Downstream consumer:

```powershell
py -3.11 D:/workspace/tools/lib/goalroute/scripts/validate-route.py <route.json> --verify-receipt <route.receipt.json>
```
