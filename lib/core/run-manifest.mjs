...
export async function writeCanonicalManifest(store, binding) {
  ...
  const value = { schemaVersion: 1, kind: 'nemesis-run-manifest', binding, sourceRevision, terminalAbsences, artifacts, digest: digest({ binding,sourceRevision,terminalAbsences, artifacts }) };
