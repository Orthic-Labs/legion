...
export function compileDesignerAuditProfile({ entries = [], sourceUri = 'nemesis-skill://designer/' } = {}) {
  ...
  return { schemaVersion: 1, kind: 'nemesis-designer-audit-profile', sourceUri, rules, exclusions,
