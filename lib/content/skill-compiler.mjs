...
export function compileWritingAuditProfile({ entries = [], sourceUri = 'legion-skill://writing/' } = {}) {
  ...
  return { schemaVersion: 1, kind: 'legion-writing-audit-profile', sourceUri, rules, exclusions, status: entries.length ? 'pass' : 'unproven', coverageGaps: entries.length ? [] : ['writing-skill-bundle-missing'] };
}
