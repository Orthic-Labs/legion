...
export const MECHANICAL_REGISTRY = Object.freeze({
  schemaVersion: 1,
  kind: 'nemesis-mechanical-remediation-registry',
  source: 'lib/remediation/producers/',
  generator: 'lib/remediation/mechanical.mjs',
...
function assertSandbox(sandbox) {
  if (sandbox?.kind !== 'nemesis-remediation-sandbox') {
