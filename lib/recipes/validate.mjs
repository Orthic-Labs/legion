...
export function validateInternalRecipes(root) {
  ...
  const index = JSON.parse(readFileSync(resolve(root, 'registry/recipes/index.json'), 'utf8'));
  const records = index.recipes.map((id) => JSON.parse(readFileSync(resolve(root, 'recipes', `${id}.json`), 'utf8')));
