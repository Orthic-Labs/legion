...
export function capabilityReceipt(input = {}) {
  ...
  return { schemaVersion: 1, kind: 'nemesis-platform-capability', id: input.id, status, isolation: input.isolation ?? null,
...
export function terminalScenarioReceipt(input = {}) {
  ...
  return { schemaVersion: 1, kind: 'nemesis-platform-scenario-receipt', scenarioId: input.scenarioId,
