const URI = /^nemesis-skill:\/\/([a-z0-9-]+)\/(.*)$/;
...
export function validateSkillBundle(bundle) {
  ...
  const root=`nemesis-skill://${bundle.id}/`;if(bundle.rootUri!==root)throw new TypeError('skill root must match bundle-owned nemesis-skill URI');
