...
export async function runPackageSmoke(root=resolve(import.meta.dirname,'..')){
  ...
  try{
    ...
    python(['-c',"from decision_provider import produce_candidate_set; assert produce_candidate_set('package smoke', {'repositoryId': '.', 'maxCandidates': 1}).candidates == ()"],{cwd:join(assembled,'lib'),encoding:'utf8'});
