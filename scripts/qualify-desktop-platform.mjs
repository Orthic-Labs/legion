...
export async function qualifyDesktopPlatformFile(path) {
  ...
  return { schemaVersion: 1, kind: 'legion-desktop-provisional-bundle', status: pack.stopShip ? 'fail' : qualification.status === 'pass' && pack.status === 'pass' ? 'pass' : 'partial', terminal: true, provisional: true, qualification, pack };
}
