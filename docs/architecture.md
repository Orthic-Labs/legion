...
- Stale claims: **21** _(source: .agent/stale.json:staleClaims)_
- Missing references: **49** _(source: .agent/stale.json:missingReferences)_
...
Generated from index signature `48a80713d59c8ce4ad1dfa3f19837938`. Unchanged-repo rebuilds are byte-identical.
