...
D:/Claude/tools/skills/designer/engine/scripts/detect.mjs # hardcoded Windows absolute path
```
...
1. Inventory every `tools/...` and `D:/Claude/tools/...` occurrence across the repository
   (1,532 raw matches).
...
D:/Claude/tools/skills/designer/engine/scripts/detect.mjs  ->  skills/designer/engine/scripts/detect.mjs
