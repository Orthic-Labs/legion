...
| LEG-I006 | LEG-016 | Plan seal/signature, SARIF writer & Blueprint generation pinning | `tools/audit/audit-run.mjs@LOCAL`; `tools/audit/audit-plan.mjs@LOCAL`; `tools/audit/audit-finalize.mjs@LOCAL` (SARIF writer in its own CLI `main()`) | ORIGINAL | PARTIAL | Unreachable from `legion audit`; only `scripts/self-test.mjs` & tests reference them |
...
|---|---|---|---|---|---|
| LEG-Q001 | LEG-001, LEG-002, LEG-003, LEG-004, LEG-005, LEG-006, LEG-007, LEG-008, LEG-009, LEG-010, LEG-011, LEG-012, LEG-013, LEG-014, LEG-015, LEG-016, LEG-017, LEG-018, LEG-019, LEG-020, LEG-021, LEG-022, LEG-023, LEG-024, LEG-025, LEG-026, LEG-027 | Legion-AC-BOUNDARY-001: reconcile each observable through live consumer at PUSHED boundary | PENDING | NONE | LOCAL |
...
| LEG-D004 | REFERENCE | LEG-016 | Legacy `tools/audit` pipeline (`audit-run.mjs`, `audit-plan.mjs`, orphaned `audit-finalize.mjs` CLI) is orphaned from `legion audit`; only `scripts/self-test.mjs` & tests reach it. | Live-path trace, 2026-08-31 | RECORDED |
