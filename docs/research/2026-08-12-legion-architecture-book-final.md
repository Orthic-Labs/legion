...
7. the 13 August commit-pinned external-practices comparison across eighteen agent, review, testing, ownership, and execution-harness repositories (corpus recorded in `docs/research/competitors.md`).
8. the 13 August Kimi/Muse merged control-integrity review (`docs/research/archive/muse.md`; the merged Kimi input is no longer retained): eighteen deduplicated additions, preserved here without its rejected duplicate stores, fixed calibration constants, blanket hard cuts, or parallel decay machinery.
...
**Pinned provenance inputs (SHA-256):** `sol.md` (removed; corpus preserved in `docs/research/competitors.md`) `127342f6f110c86c11d8be8a7ffd4a0cb0fa890544bcf9dd070e67a5cafaddc3`; `ds.md` `f27040c9f96de9609e0cbf3aea7fbd33cfd29172b25b22c795daaaa0596202dc`; `k3.md` (removed) `3981ed41255feda523caaa1e5c3ef8c6b48eb4f049f789710756208f6b7bc40c`; `muse.md` `1a89cc46119ee89aa74ad959ee870a3aef29f44e115d1567dc19fc8f91cbe412`. These archived inputs reproduce book provenance; they are evidence, not live operational doctrine.
...
- **External-practices comparison (2026-08-13; corpus in `docs/research/competitors.md`)** — commit-pinned comparison of eighteen local repositories; identifies five net-new control families and four existing-contract improvements, with exact book integration, evals, implementation order, rejection list, and per-repository evidence ledger. It remains implementation research, not a replacement canon.
