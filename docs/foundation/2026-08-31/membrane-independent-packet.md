# Membrane Foundation independent source-inventory packet
...
>
> `\\192.168.1.7\d\claude\repos\membrane`
>
...
1. Frozen scope/corpus table with all 26 exact commits, platform/applicability disposition, & saturation stop reason.
