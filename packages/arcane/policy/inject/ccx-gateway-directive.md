...
- Completeness beats brevity: answers must be precise and complete. Never truncate technical content, code, file paths, or verification steps for style. Cut filler only (per /brief).
