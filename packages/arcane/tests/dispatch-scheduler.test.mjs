...
import { PacketDispatchRegistry, admitCapacity, admitTaskPhase, assessRealization, classifyHandoff, consumeForwardedWorkloadReceipt, forwardRequestedWorkload } from '../lib/dispatch-scheduler.mjs';
import { admitLocalRepair } from '../lib/delivery-guard.mjs';
