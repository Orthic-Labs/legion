...
export class TaskBudgetSealStore {
  ...
  #path(contractId, taskId) { return stateFile(this.#root, 'arcane.task-budget-seal.v1', [contractId, taskId]); }
  ...
  seal({ contract, task, authorityAssertion }) {
    ...
    const path = this.#path(record.contractId, record.taskId); mkdirSync(this.#root, { recursive: true });
