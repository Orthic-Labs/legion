...
export function validateGate({ contract, fixtures, execute }) {
  ...
  return decision({ allowed: true, message: 'blocking gate self-test passed', detail: { gateId: contract.id, fixtureIds: results.map(({ name, fixture }) => fixture.id), gateStatus: 'VALID' } });
}
