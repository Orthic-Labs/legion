...
export function buildReviewPacket(input = {}) {
  const packet = { schemaVersion: 1, kind: 'nemesis-visual-review-packet', scope: input.stateGroup ? 'state-group' : 'surface', surfaceId: input.surfaceId,
...
export function validateJudgmentReceipt(packet, input = {}) {
  ...
  const receipt = { schemaVersion: 1, kind: 'nemesis-judgment-receipt', family: 'visual', subjectId: packet.surfaceId, candidateId: packet.digest,
