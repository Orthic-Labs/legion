...
export async function runWebControl({ binding = {}, family, input = {} } = {}) {
  ...
  if (family === 'api') {
    ...
    return finalize('nemesis-web-api-provider', { ...receipt, provider: 'runtime.web', delegatedProvider: delegatedProvider ?? 'runtime.service.api' });
  }
  return finalize('nemesis-web-control-receipt', { status: 'blocked', terminal: true, binding, family: family ?? null, coverageGaps: ['web-control-family-unsupported'] });
}
