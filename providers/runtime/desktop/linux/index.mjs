...
export function evaluateLinuxPlatform({ matrix = {}, artifact = {}, checks = [], capability = {} } = {}) {
  ...
  return { schemaVersion: 1, kind: 'nemesis-desktop-linux', status: gaps.length ? 'unproven' : 'pass', terminal: true, matrix: boundMatrix, artifact, receipts: checks, coverageGaps: gaps.sort() };
}
