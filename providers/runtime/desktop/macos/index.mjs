...
export function evaluateMacosPlatform({ matrix = {}, artifact = {}, checks = [], capability = {} } = {}) {
  ...
  return { schemaVersion: 1, kind: 'legion-desktop-macos', status: gaps.length ? 'unproven' : 'pass', terminal: true, matrix: boundMatrix, artifact, receipts: checks, coverageGaps: gaps.sort() };
}
