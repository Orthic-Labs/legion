// Reading Adrian's recent instructions inside the hook, so an approval he
...
test('echoed repo content never carries authority', () => {
  ...
  assert.equal(classifyContentOriginHint('Contents of D:/Claude/docs/GOTCHAS.md:'), 'repo_file');
...
test('system-injected user turns are not Adrian', () => {
...
test('a recent directive from Adrian authorizes', () => {
  const raw = transcript([
