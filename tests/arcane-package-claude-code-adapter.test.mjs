...
import { validateHostEvent, normalizeHostEvent } from '../src/lib/host/arcane/host-event.mjs';
...
import { loadPolicy, PolicyEngine, DEFAULT_POLICY_PATH, policyDuplicationAudit } from '../src/lib/guard/compat/policy/policy.mjs';
...
test('EC-4: policyDuplicationAudit finds zero violations in the modified adapter', () => {
  const adapterPath = fileURLToPath(new URL('../src/lib/guard/compat/host/claude-code-adapter.mjs', import.meta.url));
