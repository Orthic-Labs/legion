...
import { keyHex, stateFile, statePaths } from '../src/lib/contracts/arcane/state-paths.mjs';

const schemas = new RuntimeSchemaSet();
const schemaDir = join(import.meta.dirname, '..', 'src', 'lib', 'contracts', 'arcane-schemas');
