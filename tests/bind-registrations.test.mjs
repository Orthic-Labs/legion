...
test('the incident is caught: settings.json wiring on top of a plugin is a duplicate', () => {
  const h = host({
    userHooks: stopHook('/Users/x/.nvm/versions/node/v26.7.0/bin/node /Volumes/D/claude/legion/hooks/arcane-hook.mjs'),
...
test('handler identity survives absolute-path differences across machines', () => {
  assert.equal(
    ...
    handlerId('/Users/x/.nvm/versions/node/v26.7.0/bin/node /Volumes/D/claude/legion/hooks/arcane-hook.mjs'),
  );
