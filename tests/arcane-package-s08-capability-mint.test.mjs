...
import { PreEffectGate } from '../src/lib/guard/compat/effects/preeffect-gate.mjs';
import { loadPolicy, PolicyEngine, DEFAULT_POLICY_PATH, capabilityIssuanceAudit } from '../src/lib/guard/compat/policy/policy.mjs';
import { AuthorityLedger } from '../src/lib/contracts/arcane/authority.mjs';
import { CapabilityStore } from '../src/lib/guard/compat/audit/receipt-store.mjs';
...
import { UserApprovalAuthority } from '../src/lib/guard/compat/effects/user-approval.mjs';
