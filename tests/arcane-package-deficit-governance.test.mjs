...
import { acknowledgeDownstreamDeficits, classifyAcceptanceDeficits, convertDeficitsToDebt, evaluateOutcomeClosure } from '../src/lib/cli/commands/governance/judgment/deficit-governance.mjs';
