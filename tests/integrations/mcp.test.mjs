...
import { listTools, callTool } from '../../src/integrations/mcp/tools.mjs';
import { mcpInstallConfig, installPreview } from '../../src/integrations/mcp/install.mjs';

const SERVER = fileURLToPath(new URL('../../src/integrations/mcp/server.mjs', import.meta.url));
