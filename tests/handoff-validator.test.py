...
def main() -> int:
    spec = importlib.util.spec_from_file_location("handoff_validator", VALIDATOR_MODULE)
    ...
    cache_packet = (FIXTURES / "cache" / "handoff.md").resolve()
    ...
    validator_packet = (FIXTURES / ".validator-case" / "handoff.md").resolve()
