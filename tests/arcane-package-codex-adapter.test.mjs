...
} from '../src/lib/guard/compat/host/codex-adapter.mjs';
import { validateHostEvent } from '../src/lib/host/arcane/host-event.mjs';
...
test('EC-503 v6: fresh Codex process gives durable thread identity precedence over transient session id', () => {
  const adapter = new URL('../src/lib/guard/compat/host/codex-adapter.mjs', import.meta.url).href;
