...
import { completionIntegratedState, completionIntegratedStateForRepositories, latestScopedMaterialChange } from '../src/lib/verification/arcane/completion-state.mjs';
