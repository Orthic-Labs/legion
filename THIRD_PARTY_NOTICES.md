...
The canonical package manifest (`@orthic-labs/legion`, PR05) declares no
...
distribution inventory. Rule packs under `registry/rules/` are original Legion
material.

## Rule packs and fixtures

The benchmark fixture corpus (`bench/fixtures/`) is original Legion material.
