...
- **Target:** New Codex Desktop task with workspace access to D:/workspace
...
- **OS / shell:** Windows PowerShell on D:/workspace; Python launcher py -3.11.
- **Tools / dependencies:** Stdlib Python validators only; skill discovery validator through D:/workspace/tools/skills/.system/skill-creator/scripts/quick_validate.py; run relevant test files with py -3.11.
...
| DECISION-06 | Preserve unrelated dirty work; stage only scoped files; primary checkout only. | D:/workspace/AGENTS.md & current dirty state. | LOCKED | User explicitly requests broad cleanup or isolation. |
...
|---|---|---|---|---|---|
| Dispatch skill | D:/workspace/tools/skills/dispatch/SKILL.md | Durable zero-context delegation rules | DRAFT_READY | live uncommitted source | Earlier scoped static validation passed; re-run after final edits. |
| Dispatch validator tests | D:/workspace/tools/skills/dispatch/scripts/test_validate_dispatch.py | Rejects structural, semantic, status, script, receipt bypasses | COMPLETE | stdlib Python | Earlier output: PASS with concrete packet & adversarial rejections. |
| Dispatch forward packet | D:/workspace/tools/skills/dispatch/examples/validated-forward-test.md | Fresh-agent authored packet proof | COMPLETE | sha256 42a0c84903c95c89fd370dead48c90f18c568a5ca9c8aecbd475ab6cfca475be | Dispatch validator & receipt verifier passed. |
| Dispatch forward receipt | D:/workspace/tools/skills/dispatch/examples/validated-forward-test.receipt.json | Exact-bytes evidence for dispatch proof | COMPLETE | sidecar JSON | Receipt verifier passed against dispatch forward packet. |
| Handoff skill | D:/workspace/tools/skills/handoff/SKILL.md | Cold-start context-transplant rules | DRAFT_READY | live uncommitted source | Earlier static validation & adversarial test passed; re-run after this proof. |
| Handoff validator tests | D:/workspace/tools/skills/handoff/scripts/test_validate_handoff.py | Rejects readiness, secret, resume, table, temporary-storage, receipt bypasses | COMPLETE | stdlib Python | Earlier output: PASS with durable cold-start packet & adversarial rejections. |
| This handoff packet | D:/workspace/tools/skills/handoff/examples/validated-forward-test.md | Fresh-reader handoff proof | IN_PROGRESS | receipt written by Step 1 validation | Validate & bind receipt before transfer. |
| Council packet mode | D:/workspace/tools/skills/council/SKILL.md | Third-party problem brief without review execution | DRAFT_READY | live uncommitted source | Packet-only rules, external template, validator, & eval entries exist; include in final validation. |
| Skill registrations | D:/workspace/.claude/rules/skills.md; D:/workspace/docs/SKILL-ARCHITECTURE.md | Discovery & architecture registration | DRAFT_READY | scoped modified files | Re-run skill discovery validation. |
...
|---|---|---|---|---|---|---|
| FAILURE-01 | dual-review jury-plan --stage advisory --room | Council room fell to provider-failure path; Claude CLI unauthenticated & MiniMax proxy unavailable. | External review credentials/routes unavailable in current environment. | D:/workspace/tools/review/.council-runs/dispatch-skill-20260728/ | Provider credential/route is deliberately restored & named by user. | Use isolated native Council fallback, preserve findings/disposition, then run fresh native Jury. |
...
| Dirty checkout | git status contains multiple unrelated concurrent changes & submodule state. | Never reset, revert, stage-all, switch, or commit unrelated paths. | Live inventory & D:/workspace/AGENTS.md. |
...
- **Owner:** Cold receiver
- **Working directory / system:** D:/workspace
- **Exact action:**

```text
Set-Location D:/workspace; git branch --show-current; git rev-parse HEAD; git status --short; py -3.11 D:/workspace/tools/skills/handoff/scripts/validate-handoff.py D:/workspace/tools/skills/handoff/examples/validated-forward-test.md --verify-receipt D:/workspace/tools/skills/handoff/examples/validated-forward-test.receipt.json
```
...
- **Evidence path:** D:/workspace/tools/skills/handoff/examples/validated-forward-test.receipt.json
...
- **Depends on:** D:/workspace/tools/skills/handoff/examples/validated-forward-test.md
...
```text
Run scoped validators: Set-Location D:/workspace; py -3.11 D:/workspace/tools/skills/dispatch/scripts/test_validate_dispatch.py; py -3.11 D:/workspace/tools/skills/handoff/scripts/test_validate_handoff.py; py -3.11 D:/workspace/tools/skills/.system/skill-creator/scripts/quick_validate.py D:/workspace/tools/skills/dispatch; py -3.11 D:/workspace/tools/skills/.system/skill-creator/scripts/quick_validate.py D:/workspace/tools/skills/handoff; py -3.11 D:/workspace/tools/skills/.system/skill-creator/scripts/quick_validate.py D:/workspace/tools/skills/council
```

- **Expected result:** Every command exits 0; both test files print PASS; each quick validator prints Skill is valid.
- **Evidence path:** D:/workspace/tools/skills/dispatch/scripts/test_validate_dispatch.py; D:/workspace/tools/skills/handoff/scripts/test_validate_handoff.py
...
- **Evidence path:** D:/workspace/tools/review/.council-runs/dispatch-handoff-final/; D:/workspace/tools/skills/dispatch/examples/validated-forward-test.receipt.json; D:/workspace/tools/skills/handoff/examples/validated-forward-test.receipt.json
...
```text
Run state verification: Set-Location D:/workspace; git status --short; git branch --show-current; git rev-parse HEAD; py -3.11 D:/workspace/tools/skills/dispatch/scripts/test_validate_dispatch.py; py -3.11 D:/workspace/tools/skills/handoff/scripts/test_validate_handoff.py
```
...
```powershell
py -3.11 D:/workspace/tools/skills/handoff/scripts/validate-handoff.py D:/workspace/tools/skills/handoff/examples/validated-forward-test.md --write-receipt D:/workspace/tools/skills/handoff/examples/validated-forward-test.receipt.json
```

- **Receiver receipt check:**

```powershell
py -3.11 D:/workspace/tools/skills/handoff/scripts/validate-handoff.py D:/workspace/tools/skills/handoff/examples/validated-forward-test.md --verify-receipt D:/workspace/tools/skills/handoff/examples/validated-forward-test.receipt.json
```
...
BEGIN HANDOFF PACKET AT: D:/workspace/tools/skills/handoff/examples/validated-forward-test.md
RECEIPT AT: D:/workspace/tools/skills/handoff/examples/validated-forward-test.receipt.json
```
