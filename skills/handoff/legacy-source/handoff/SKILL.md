...
```bash
python3 /workspace/tools/skills/handoff/scripts/transcript-handoff.py bootstrap --platform codex --session-id "<TASK_ID>" --workspace "<WORKSPACE>"
```

Use `py -3.11 D:/workspace/tools/skills/handoff/scripts/transcript-handoff.py ...` on Windows. Return
