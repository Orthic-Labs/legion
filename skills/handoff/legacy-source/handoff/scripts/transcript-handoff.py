...
_WORKSPACE = _HERE.parents[4]  # scripts/ -> handoff/ -> skills/ -> tools/ -> repo
...
def paste_prompt(pointer: dict[str, Any]) -> str:
    ...
    script_path = (
        workspace / "tools" / "skills" / "handoff" / "scripts"
...
Load `D:/workspace/tools/skills/handoff/SKILL.md` & enter `TRANSCRIPT_INGEST`.
