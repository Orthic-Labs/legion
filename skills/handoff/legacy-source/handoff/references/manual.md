...
```powershell
py -3.11 D:/Claude/tools/skills/handoff/scripts/transcript-handoff.py bootstrap --platform codex --session-id "<CURRENT_TASK_ID>" --workspace "<CURRENT_WORKSPACE>"
```
...
```bash
python3 /Volumes/D/claude/tools/skills/handoff/scripts/transcript-handoff.py bootstrap --platform claude --session-id "<CURRENT_TASK_ID>" --workspace "/Volumes/D/claude"
```
...
```powershell
py -3.11 D:/Claude/tools/skills/handoff/scripts/validate-handoff.py <handoff.md> --write-receipt <handoff.receipt.json>
py -3.11 D:/Claude/tools/skills/handoff/scripts/validate-handoff.py <handoff.md> --verify-receipt <handoff.receipt.json>
```

macOS:

```bash
python3 /Volumes/D/claude/tools/skills/handoff/scripts/validate-handoff.py <handoff.md> --write-receipt <handoff.receipt.json>
python3 /Volumes/D/claude/tools/skills/handoff/scripts/validate-handoff.py <handoff.md> --verify-receipt <handoff.receipt.json>
```
