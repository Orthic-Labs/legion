---
name: council
description: "Run the explicit multi-model Council, revision gate, and fresh Jury, or author /council packet without reviewers. Use only when the operator asks for Council, Jury, a multi-model panel, external review, or a Council packet."
---
