...
- `legion-skill://ads/references/image-providers.md`: API setup and pricing
- `legion-skill://ads/references/brand-dna-template.md`: Brand injection schema
- `legion-skill://ads/references/meta-creative-specs.md`: Safe zone for 9:16
- `legion-skill://ads/references/tiktok-creative-specs.md`: Safe zone constraints
