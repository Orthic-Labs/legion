...
LinkedIn, TikTok, Microsoft). All ad work enters through `/ads`. Detailed
per-platform and per-task instructions live in `references/` and are loaded
on-demand by Read tool. NOT separate skills.

## Front-Door Hard Gates

Before strategy, creative, or optimization recommendations, verify these. If a gate fails, fix or request the missing input before proceeding.

- **Offer gate:** campaign has a specific audience, promise, mechanism, CTA, and conversion event. If copy is the blocker, route through `writing`'s copy branch.
- **Proof gate:** claims, numbers, guarantees, testimonials, and before/after promises are supported or removed.
- **Tracking gate:** conversion event, pixel/tag, attribution window, UTMs, and reporting source are known. No optimization plan without measurement.
- **Landing-page gate:** ad promise matches landing page headline/offer, page has trust/proof, clear CTA, fast load, and mobile usability. Use `designer` or `audit-visual` if the page is weak. When a landing page URL/local preview must be opened, use the shared `qa` skill for hidden screenshots and click/hover/CTA checks; do not rely on foreground desktop screenshots.
- **Platform-native gate:** creative matches platform constraints, placement, format, audience behavior, and first-second/first-line hook.
- **Compliance gate:** regulated categories, claims, targeting, privacy, and platform policy risks are checked.
- **Anti-slop gate:** no generic hooks, bland stock creative, unsupported "limited time" urgency, or ad copy that could fit any competitor.

Failing a front-door gate blocks launch recommendations.

## Routing — by intent (Read the matching reference file before acting)
...
| LinkedIn Ads (B2B, Lead Gen) | `references/linkedin.md` + `references/linkedin-audit.md` |
| TikTok Ads (Creative, Shop, Smart+) | `references/tiktok.md` + `references/tiktok-audit.md` |
| Microsoft/Bing Ads | `references/microsoft.md` + `references/microsoft-audit.md` |
| Apple Search Ads | `references/apple.md` |
| Cross-platform creative quality | `references/create.md` |
| Bulk creative generation / variants | `references/generate.md` |
| Landing page conversion check | `references/landing.md` |
| Budget allocation / bidding review | `references/audit-ad-budget.md` + `references/budget-allocation.md` + `references/bidding-strategies.md` |
| Competitor ad intelligence | `references/competitor.md` |
| Brand DNA extraction from URL | `references/dna.md` + `references/brand-dna-template.md` |
| Product photography (5 styles) | `references/photoshoot.md` |
| Industry benchmarks lookup | `references/benchmarks.md` |
| Conversion tracking audit | `references/conversion-tracking.md` |
| Compliance / policy check | `references/compliance.md` |
| Audience targeting strategy | `references/audience-targeting.md` |
| Ad copy frameworks | `references/copy-frameworks.md` + `references/ad-copy-templates.md` |
| Platform setup checklists | `references/platform-setup-checklists.md` |
| Scoring rubric | `references/scoring-system.md` |

## Internal Ads Council

Use this after route selection and context intake, before recommendations or creative output. This is a self-council for better ad work, not `/review ad` and not a CLI/API jury.

| Task/ref group | Role pass |
|---|---|
| Platform/account audits | Platform specialist, measurement lead, budget analyst, compliance guard |
| Creative/create/generate/photoshoot | Creative strategist, platform-native producer, brand guardian, conversion skeptic |
| Landing page | Message-match lead, CRO designer, trust/proof skeptic, performance/accessibility lead |
| Budget/bidding | Media buyer, finance/unit-economics lead, learning-phase guard, scaling operator |
| Audience/retargeting | Audience strategist, segmentation skeptic, privacy/compliance guard, experiment designer |
| Competitor/DNA | Positioning analyst, offer mapper, visual-language extractor, proof skeptic |
| Tracking/compliance | Attribution engineer, data-quality auditor, policy reviewer, privacy guard |

Visible output should be the synthesized recommendation, prioritized risks, and the next action. Show role notes only if they explain a tradeoff.

## Quick command shorthand (legacy compatibility)

| Command | Loads |
|---------|-------------|
| `/ads audit` | All platform refs in parallel via subagents |
| `/ads google` | `references/google.md` + `references/google-audit.md` |
| `/ads meta` | `references/meta.md` + `references/meta-audit.md` |
| `/ads youtube` | `references/youtube.md` + `references/youtube-creative-specs.md` |
| `/ads linkedin` | `references/linkedin.md` + `references/linkedin-audit.md` |
| `/ads tiktok` | `references/tiktok.md` + `references/tiktok-audit.md` |
| `/ads microsoft` | `references/microsoft.md` + `references/microsoft-audit.md` |
| `/ads apple` | `references/apple.md` |
| `/ads create` | `references/create.md` + `references/copy-frameworks.md` |
| `/ads generate` | `references/generate.md` |
| `/ads landing` | `references/landing.md` |
| `/ads budget` | `references/audit-ad-budget.md` |
| `/ads competitor` | `references/competitor.md` |
| `/ads dna <url>` | `references/dna.md` |
| `/ads photoshoot` | `references/photoshoot.md` |
