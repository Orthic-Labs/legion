...
[Reads legion-skill://ads/references/brand-dna-template.md for schema]
[Reads legion-skill://ads/references/benchmarks.md for platform copy guidance]
...
3. **Read reference files** (load on-demand):
   - `legion-skill://ads/references/brand-dna-template.md`: for voice axis interpretation
