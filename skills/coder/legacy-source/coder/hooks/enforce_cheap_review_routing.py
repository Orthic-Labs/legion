"""RETIRED 2026-07-05 — do not re-register. Adrian locked the no-external-model-API rule:
...
REASON = (
    ...
    "  py -3.11 D:/Claude/tools/skills/coder/scripts/api-worker.py --batch manifest.json --pool-size 4\n"
