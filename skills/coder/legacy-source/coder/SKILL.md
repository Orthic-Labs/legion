---
name: coder
description: Explicit opt-in router for scoped read-only code work through external API models. Use only when Adrian says `/coder`, asks to outsource code analysis, or names an API provider/model. Never auto-route audit, cortex, commit, architect, research, or other workspace work here.
---
