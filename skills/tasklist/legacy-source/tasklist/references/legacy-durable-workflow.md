...
```powershell
py -3.11 D:/workspace/tools/skills/tasklist/scripts/validate-tasklist.py <name>.tasklist.md --write-receipt <name>.tasklist.receipt.json
```

macOS:

```bash
python3 /workspace/tools/skills/tasklist/scripts/validate-tasklist.py <name>.tasklist.md --write-receipt <name>.tasklist.receipt.json
```

Before execution/resume:

```powershell
py -3.11 D:/workspace/tools/skills/tasklist/scripts/validate-tasklist.py <name>.tasklist.md --verify-receipt <name>.tasklist.receipt.json
```
