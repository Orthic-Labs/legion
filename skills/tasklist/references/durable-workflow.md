...
4. Validate packet with Tasklist compatibility wrapper; it delegates to package-local `lib/dispatch-validator/validate-tasklist.py` & writes sibling receipt.
