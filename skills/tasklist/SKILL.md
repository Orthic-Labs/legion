...
3. For persistent or auditable work, read [durable workflow](references/durable-workflow.md), copy [template](assets/tasklist-template.md), & validate typed execution packet with `python3 tools/skills/legion/skills/tasklist/scripts/validate-tasklist.py <packet.json>`. It writes a sibling receipt.
