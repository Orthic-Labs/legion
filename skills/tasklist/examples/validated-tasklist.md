...
- **Canonical path:** /workspace/tools/skills/tasklist/examples/validated-tasklist.md
- **Status:** PLANNED
...
- **Success proof:** PROOF_COMMAND:py -3.11 /workspace/tools/skills/tasklist/scripts/test_validate_tasklist.py; EXPECTED:Exit 0 and output begins PASS: tasklist validator.; EVIDENCE:/workspace/.audit/tasklist-example/test-output.txt
...
- **Goal route artifact:** /workspace/tools/skills/tasklist/examples/validated-tasklist.route.json
- **Goal route receipt:** /workspace/tools/skills/tasklist/examples/validated-tasklist.route.receipt.json
...
- **Done check:** CHECK:py -3.11 /workspace/tools/lib/goalroute/scripts/validate-route.py /workspace/tools/skills/tasklist/examples/validated-tasklist.route.json --verify-receipt /workspace/tools/skills/tasklist/examples/validated-tasklist.route.receipt.json
...
- **Done check:** CHECK:py -3.11 /workspace/tools/skills/tasklist/scripts/validate-tasklist.py /workspace/tools/skills/tasklist/examples/validated-tasklist.md --write-receipt /workspace/tools/skills/tasklist/examples/validated-tasklist.receipt.json
...
- **Done check:** CHECK:py -3.11 /workspace/tools/skills/tasklist/scripts/validate-tasklist.py /workspace/tools/skills/tasklist/examples/validated-tasklist.md --verify-receipt /workspace/tools/skills/tasklist/examples/validated-tasklist.receipt.json
- **Expected result:** EXPECTED:exit 0 and RECEIPT_PASS output
...
- **Final verification:** py -3.11 /workspace/tools/skills/tasklist/scripts/test_validate_tasklist.py
