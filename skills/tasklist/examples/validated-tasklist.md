...
- **Canonical path:** D:/workspace/tools/skills/tasklist/examples/validated-tasklist.md
- **Status:** PLANNED
...
- **Success proof:** PROOF_COMMAND:py -3.11 D:/workspace/tools/skills/tasklist/scripts/test_validate_tasklist.py; EXPECTED:Exit 0 and output begins PASS: tasklist validator.; EVIDENCE:D:/workspace/.audit/tasklist-example/test-output.txt
...
- **Rate:** LINES_PER_MINUTE:30

## 2. GoalRoute Binding

- **Goal route artifact:** D:/workspace/tools/skills/tasklist/examples/validated-tasklist.route.json
- **Goal route receipt:** D:/workspace/tools/skills/tasklist/examples/validated-tasklist.route.receipt.json
...
- **Done check:** CHECK:py -3.11 D:/workspace/tools/lib/goalroute/scripts/validate-route.py D:/workspace/tools/skills/tasklist/examples/validated-tasklist.route.json --verify-receipt D:/workspace/tools/skills/tasklist/examples/validated-tasklist.route.receipt.json
- **Expected result:** EXPECTED:exit 0 and RECEIPT_PASS output
- **Evidence path:** D:/workspace/.audit/tasklist-example/route-check.txt
...
- **Done check:** CHECK:py -3.11 D:/workspace/tools/skills/tasklist/scripts/validate-tasklist.py D:/workspace/tools/skills/tasklist/examples/validated-tasklist.md --write-receipt D:/workspace/tools/skills/tasklist/examples/validated-tasklist.receipt.json
- **Expected result:** EXPECTED:exit 0 and PASS output
- **Evidence path:** D:/workspace/.audit/tasklist-example/structure-check.txt
...
- **Done check:** CHECK:py -3.11 D:/workspace/tools/skills/tasklist/scripts/validate-tasklist.py D:/workspace/tools/skills/tasklist/examples/validated-tasklist.md --verify-receipt D:/workspace/tools/skills/tasklist/examples/validated-tasklist.receipt.json
- **Expected result:** EXPECTED:exit 0 and RECEIPT_PASS output
- **Evidence path:** D:/workspace/.audit/tasklist-example/receipt-check.txt
...
- **Final verification:** py -3.11 D:/workspace/tools/skills/tasklist/scripts/test_validate_tasklist.py
- **Final expected result:** exit 0 and PASS: tasklist validator output
- **Final evidence path:** D:/workspace/.audit/tasklist-example/test-output.txt
