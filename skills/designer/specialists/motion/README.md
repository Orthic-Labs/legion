...
**Qualitative reviewer bar lives in `skills/designer/references/motion-standards.md`** — Designer owns escalation triggers, remedial hierarchy, & findings format.
...
Full contract: `skills/designer/specialists/motion/GUIDE.md` (`Routing contract`).
...
- Add a new easing to `principles.md` → check `reviews.md`; update `skills/designer/references/motion-standards.md` if it diverges.
