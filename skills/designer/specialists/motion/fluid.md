...
- Typography optical sizing/tracking is owned by `/designer` craft rules +
  `skills/designer/references/typography.md`.
- Designer review values (dismissal threshold, spring configs, boundaries): `skills/designer/references/motion-standards.md`
