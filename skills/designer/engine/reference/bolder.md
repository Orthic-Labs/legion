...
- **Replace generic fonts**: Swap system fonts for distinctive choices (see the parent skill's typography guidelines and the [Reference Material section of typeset.md](nemesis-skill://designer/engine/reference/typeset.md#reference-material) for inspiration)
...
When the result feels right, hand off to `/designer polish` for the final pass.
