...
- **Replace generic fonts**: Swap system fonts for distinctive choices (see the parent skill's typography guidelines and the [Reference Material section of typeset.md](legion-skill://designer/engine/reference/typeset.md#reference-material) for inspiration)
