...
const SEEDS = [
  ...
  { id: "seed-188", oklch: [0.400, 0.110, 250.0],
    mood: "Linear's considered indigo — the calm authority of a well-built developer tool, cortex ink on a clean page",
  ...
  { id: "seed-165", oklch: [0.450, 0.123, 250.0],
    mood: "cortex room at dusk — drafting table, graphite, civic-engineering blue",
