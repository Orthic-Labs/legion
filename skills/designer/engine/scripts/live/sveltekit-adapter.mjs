...
export const SVELTE_LIVE_ROOT_COMPONENT = 'src/lib/designer/ImpeccableLiveRoot.svelte';
...
export const SVELTE_ROOT_IMPORT = "import ImpeccableLiveRoot from '$lib/designer/ImpeccableLiveRoot.svelte';";
