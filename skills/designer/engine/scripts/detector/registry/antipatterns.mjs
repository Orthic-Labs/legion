const ANTIPATTERNS = [
  ...
  // Browser engine only: these rules need a real viewport. Static/regex modes
  // cannot evaluate them — a static-only scan does NOT clear them.
  {
    id: 'cta-below-fold',
    category: 'structure',
  ...
  },
  {
    ...
    skillSection: 'Structure',
    skillGuideline: 'internal links resolve',
  },
  {
    id: 'missing-required-page',
    category: 'structure',
    name: 'Required page not linked',
    description:
    ...
    skillSection: 'Structure',
    skillGuideline: 'required page set is linked',
  },
];
