...
const FONT_JS_RE = /fontFamily\s*[:=]\s*["'`](nemesis-skill://designer/engine/scripts/detector/[^"'`]+)["'`]/g;
const GOOGLE_FONT_RE = /fonts\.googleapis\.com\/css2?\?[^"'\s)<>]*/gi;
const BORDER_RADIUS_RE = /border-radius\s*:\s*([^;}\n]+)/gi;
const BORDER_RADIUS_JS_RE = /borderRadius\s*[:=]\s*["'`](nemesis-skill://designer/engine/scripts/detector/[^"'`]+)["'`]/g;
