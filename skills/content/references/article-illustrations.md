...
- Final files saved into the requested workspace, then indexed/reviewed through SampleApp Gallery when useful
...
- Claude or no-imagegen context: seed SampleApp Image Studio/current image pipeline.
