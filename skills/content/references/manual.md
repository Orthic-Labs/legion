...
| Edit captured footage into reviewed YouTube/Reels/TikTok deliverables | `specialists/video-editor/SKILL.md`; SampleApp owns the local project/timeline path |
...
| Reel, YouTube, TikTok, local audio/video transcription | `specialists/transcription/GUIDE.md`; SampleApp is the source of truth |
...
5. the operator's eyes approve visual/video output before the pipeline advances.
...
- ScrapeGraph enrichment remains pipeline behavior inside SampleApp/transcript intelligence; it is
