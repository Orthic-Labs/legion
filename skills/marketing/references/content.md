...
`D:/Claude/Content/Storytelling/STORYTELLING_GUIDE.md` (source-verified corpus; live render at spoares.com/content). Most relevant here: §9.9 six treatments (one idea → six pieces — use before inventing new pillars), §9.3 idea pipeline, §6 personal brand system, §7 revenue connection (3:1 value-to-ask, offer ladder), §8.2 waterfall distribution.
...
- **email-pro sequence**: For email-based content
