...
|---|---|---|---|---|---|---|---|---|
| 1 | "If your accent breaks dictation, the problem isn't you." | contrarian | Show Wispr fail → Heard Right work → CTA | hook_problem_solution_cta | documentary | 9 | 9 | transcript_mined |
| 2 | ... | ... | ... | ... | ... | ... | ... | ... |
```
