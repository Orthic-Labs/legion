...
**MANDATORY OKF emit (Skill Output Contract):** after saving, run `py -3.11 D:/Claude/tools/lib/skill_emit.py report <private-overlay>/product-marketing-context.md --type context --repo <project>` so the positioning is recallable in the memory engine.
