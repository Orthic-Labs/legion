...
**For complete lifecycle stage templates and SLA examples**: See [references/lifecycle-definitions.md](legion-skill://marketing/specialists/growth/references/revops/references/lifecycle-definitions.md)
...
**For detailed scoring templates and example models**: See [references/scoring-models.md](legion-skill://marketing/specialists/growth/references/revops/references/scoring-models.md)
...
**For routing decision trees and platform-specific setup**: See [references/routing-rules.md](legion-skill://marketing/specialists/growth/references/revops/references/routing-rules.md)
...
**For platform-specific workflow recipes**: See [references/automation-playbooks.md](legion-skill://marketing/specialists/growth/references/revops/references/automation-playbooks.md)
