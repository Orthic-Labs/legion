...
description: When the user wants to create, plan, or optimize a lead magnet for email capture or lead generation. Also use when the user mentions "lead magnet," "gated content," "content upgrade," "downloadable," "ebook," "cheat sheet," "checklist," "template download," "opt-in," "freebie," "PDF download," "resource library," "content offer," "email capture content," "Notion template," "spreadsheet template," or "what should I give away for emails." Use this for planning what to create and how to distribute it. For interactive tools as lead magnets, see free-tool-strategy. For writing the actual content, see copywriting. For the email sequence after capture, see email-pro sequence.
metadata:
  version: 1.0.0
---
...
**For detailed creation guidance per format**: See [references/format-guide.md](legion-skill://marketing/specialists/growth/references/lead-magnets/references/format-guide.md)
...
**For detailed benchmarks by format and industry**: See [references/benchmarks.md](legion-skill://marketing/specialists/growth/references/lead-magnets/references/benchmarks.md)
...
- **email-pro sequence**: For nurture sequences after lead capture
