...
**For full slide-by-slide guidance**: See [references/deck-frameworks.md](legion-skill://marketing/specialists/growth/references/sales-enablement/references/deck-frameworks.md)
...
**For templates by use case**: See [references/one-pager-templates.md](legion-skill://marketing/specialists/growth/references/sales-enablement/references/one-pager-templates.md)
...
**For the full objection library**: See [references/objection-library.md](legion-skill://marketing/specialists/growth/references/sales-enablement/references/objection-library.md)
...
**For full script templates**: See [references/demo-scripts.md](legion-skill://marketing/specialists/growth/references/sales-enablement/references/demo-scripts.md)
