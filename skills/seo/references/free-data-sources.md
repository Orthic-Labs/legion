...
3. **GSC property** — the exact property string, e.g. `sc-domain:heardright.app` (domain property)
   or `https://heardright.app/` (URL-prefix). One per site.
...
[Environment]::SetEnvironmentVariable('GSC_PROPERTY','sc-domain:heardright.app','User'); $env:GSC_PROPERTY='sc-domain:heardright.app'
