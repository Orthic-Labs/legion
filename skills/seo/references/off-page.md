...
**Workflow:**
1. **Find mentions:** search `"Damned Designs" -site:damneddesigns.com` (repeat per brand +
...
> Author facts: `D:/Claude/SEO/AUTHOR-PROFILE.md`. Brand voice: `/brand <DD|RH|HR|TS>`.
