...
```
python D:/Claude/tools/skills/seo/scripts/site_audit.py --url https://site.com --json out/site_audit.json --summary
```
...
(`SEO/snapshots/2026-07-04/ahrefs_crawl.py`) after it found HeardRight's real errors — every
