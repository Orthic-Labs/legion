...
- `D:/workspace/tasks/dispatches/<YYYY-MM-DD>/<dispatch-id>.md` for cross-project studio work.
...
In `D:\workspace`, read `tools/skills/dispatch/references/agent-routing.md` before dispatching. Preserve its primary-checkout, model-tier, structured-prompt, parallel-safety, anti-hang, & integration rules.
...
```powershell
py -3.11 D:/workspace/tools/skills/dispatch/scripts/validate-dispatch.py <dispatch.md> --write-receipt <dispatch.receipt.json>
```

macOS:

```bash
python3 /workspace/tools/skills/dispatch/scripts/validate-dispatch.py <dispatch.md> --write-receipt <dispatch.receipt.json>
```
...
```powershell
py -3.11 D:/workspace/tools/skills/dispatch/scripts/validate-dispatch.py <dispatch.md> --verify-receipt <dispatch.receipt.json>
```
