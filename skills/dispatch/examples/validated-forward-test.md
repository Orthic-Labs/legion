...
- **Goal route receipt:** skills/dispatch/examples/validated-forward-test.route.receipt.json
...
GOAL_ROUTE_ARTIFACT: skills/dispatch/examples/validated-forward-test.route.json
GOAL_ROUTE_RECEIPT: skills/dispatch/examples/validated-forward-test.route.receipt.json
...
- **Validated artifact path:** `skills/dispatch/examples/validated-forward-test.md`
- **Receipt path:** `skills/dispatch/examples/validated-forward-test.receipt.json`
- **Validator command:**
