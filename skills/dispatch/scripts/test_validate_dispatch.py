...
```"""
    ...
    def replacement(match: re.Match[str]) -> str:
        ...
        if "SCRIPT_SKILL" in token:
            return "D:/Claude/tools/skills/script/SKILL.md"
...
def main() -> int:
    ...
    print("PASS: dispatch validator accepts durable packet + rejects structural, semantic, status, script, path, temporary-storage, and receipt bypasses")
    return 0
