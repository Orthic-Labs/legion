...
Read one branch. Use `references/manual.md` for mixed work. Freeze audience, goal, channel, length, facts, CTA, voice, & restrictions. Never invent quotes, statistics, testimonials, stories, or product facts. Remove generic openings, repetition, unsupported claims, rhythm monotony, & wrong-channel structure. Media → Content; design → Designer; distribution → Social; strategy → Marketing.
