...
For detailed specs and format variations, see `ad-assets/platform-specs.md`.
...
- `/ads` — campaign strategy, targeting, budgets, and optimization (not copy generation)
- `/writing copy` — landing/sales-page conversion copy (where ad traffic lands; this skill's main surface)
- `/marketing growth` — structuring creative A/B tests with statistical rigor
- `/writing` — long-form/script/repurposing content that is NOT ad or conversion copy
...
inline conversion and evidence checks.
