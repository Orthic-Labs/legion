...
1. **Node/Tauri repo** (e.g. `D:/Claude/readright/`): run `/audit`. Confirm scanner table shows `audit`+`tsc`+`build` ran; findings carry tiers; report opens via `open-for-review`.
