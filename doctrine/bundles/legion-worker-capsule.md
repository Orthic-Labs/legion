...
> `legion/skills/covenant/`; verify the live path before reuse rather than assuming the old name.
...
```powershell
py -3.11 D:/Claude/legion/lib/dispatch-validator/validate-dispatch.py <dispatch.md> --write-receipt <dispatch.receipt.json>
```

macOS:

```bash
python3 /Volumes/D/claude/legion/lib/dispatch-validator/validate-dispatch.py <dispatch.md> --write-receipt <dispatch.receipt.json>
```
...
```powershell
py -3.11 D:/Claude/legion/lib/dispatch-validator/validate-dispatch.py <dispatch.md> --verify-receipt <dispatch.receipt.json>
```
