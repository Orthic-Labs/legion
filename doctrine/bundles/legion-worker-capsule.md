...
```powershell
py -3.11 D:/Claude/tools/skills/legion/lib/dispatch-validator/validate-dispatch.py <dispatch.md> --write-receipt <dispatch.receipt.json>
```

macOS:

```bash
python3 /Volumes/D/claude/tools/skills/legion/lib/dispatch-validator/validate-dispatch.py <dispatch.md> --write-receipt <dispatch.receipt.json>
```
...
```powershell
py -3.11 D:/Claude/tools/skills/legion/lib/dispatch-validator/validate-dispatch.py <dispatch.md> --verify-receipt <dispatch.receipt.json>
```
