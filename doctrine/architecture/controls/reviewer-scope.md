...
Reviewers—including Covenant, Oracle, specialists, & self-review—cannot create acceptance, invariants, evidence duties, quality thresholds, or scope. Every unmapped observation is `DEFERRED` or `OUT_OF_SCOPE`; it cannot reopen, amend, or delay delivery. Oracle classifies evidence/finding validity; Legion applies scope. Covenant remains advisory. Preference without demonstrated failure never blocks.
