...
export const COMMANDS = Object.freeze(['init','doctor','bind','inspect','targets','components','stacks','controls','governance','skills','languages','providers','rules','schedule','plan','audit','verify','explain','report','fix','hooks','mcp','run','budget','contract','assurance','completion','host','harness','authority','state','minimize'].map((name) => Object.freeze({ name })));
