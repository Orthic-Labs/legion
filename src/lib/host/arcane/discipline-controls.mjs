...
import { readJson, repositoryRoot, stagedChanges, verifyReceipt } from '../../cognitive/arcane/minimize.mjs';
...
export function commitReceiptRequirement({ workspace, repository = workspace, policy, contracted = false }) {
  ...
  try {
    ...
    // an in-workspace file into a `../../../packages` escape and drops it out of
