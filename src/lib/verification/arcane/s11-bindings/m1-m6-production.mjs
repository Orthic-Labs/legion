...
import { admitRetry, classifyRehydratedInput, requireDiagnosisDelta } from '../../../cli/commands/governance/execution/execution-governance.mjs';
import { PacketDispatchRegistry, admitCapacity, admitTaskPhase, assessRealization, classifyHandoff } from '../../../cli/commands/governance/delivery/dispatch-scheduler.mjs';
import { admitLocalRepair } from '../../../cli/commands/governance/delivery/delivery-guard.mjs';
import { acknowledgeDownstreamDeficits, classifyAcceptanceDeficits, convertDeficitsToDebt, evaluateOutcomeClosure } from '../../../cli/commands/governance/judgment/deficit-governance.mjs';
import { FindingLifecycleStore, applyScopedRecheck, filterFindingsByThreshold, fingerprintFinding, verifyFindingClosure } from '../../../cli/commands/governance/judgment/finding-lifecycle.mjs';
...
import { recoverControlState } from '../../../cli/commands/governance/delivery/control-recovery.mjs';
import { assessControlRetirement } from '../../../cli/commands/governance/delivery/control-lifecycle.mjs';
import { ABSENCE_SURFACES, assessMigrationCutover } from '../../../cli/commands/governance/delivery/migration-cutover.mjs';
