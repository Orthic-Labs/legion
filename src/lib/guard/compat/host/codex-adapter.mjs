...
import { normalizeHostEvent } from '../../../host/arcane/host-event.mjs';
import { canonicalJson, digest } from '../../../contracts/arcane/canonical.mjs';
import { handleHookEvent, runHookMain, readStdinJson } from '../../../host/arcane/hook-adapter-core.mjs';
import { dispatchHookInvocation } from '../../../host/arcane/host-runtime.mjs';
import { serializeHostRuntimeOutput } from '../../../host/arcane/host-runtime-output.mjs';
