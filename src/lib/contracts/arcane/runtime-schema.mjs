...
const root = join(dirname(fileURLToPath(import.meta.url)), '..', 'arcane-schemas');
const FILES = Object.freeze(['contract-seal-v1.schema.json', 'authority-binding-v1.schema.json', 'capability-grant-v1.schema.json', 'capability-transition-v1.schema.json', 'user-approval-v1.schema.json', 'host-event-ledger-record-v1.schema.json', 'authority-invocation-proof-v1.schema.json', 'authority-proof-transition-v1.schema.json', 'pending-terminal-operation-v1.schema.json', 'terminal-operation-transition-v1.schema.json', 'advisory-artifact-receipt-v1.schema.json', 'advisory-certification-receipt-v1.schema.json', 'advisory-judgment-v1.schema.json', 'host-runtime-output-v1.schema.json', 'host-runtime-result-v1.schema.json', 'budget-governance-v1.schema.json', 'task-budget-seal-v1.schema.json']);
