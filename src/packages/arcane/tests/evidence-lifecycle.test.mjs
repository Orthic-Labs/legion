...
import { AcceptanceEvidenceRegistry, compareEvidenceCandidates } from '../lib/evidence-registry.mjs';
import { ProviderCapabilityRegistry } from '../lib/provider-capability.mjs';
